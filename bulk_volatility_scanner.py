...
parser.add_argument("destfolder", help="Destination folder")
...
print "modified by Matt Gfeller"
...
#sets and creates directory filename based on image filename
        directory_filename = dest_folder + "_" + "output"
